...
It is ruled the way a lodge ruled its ledger in **1821**. Name left, figure
hard right, a rule of dots across the gap so the eye cannot slide from one
line onto the next one's figure.
